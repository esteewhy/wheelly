...
public abstract class AbstractSendAsyncTask<EntityType> extends ReportingSendAsyncTask {
 ...
 public static final String GET_SPREADSHEET_QUERY =
  ...
  public AbstractSendAsyncTask(Context context, long trackId, String accountName) {
    super(context);
	...
	protected boolean performTask() {
		...
		try {
			...
			SendToGoogleUtils.sendNotification(
					context, accountName, e.getIntent(), SendToGoogleUtils.SPREADSHEETS_NOTIFICATION_ID);
			return false;
   ...
   */
	...
	private Drive getDriveService(String scope)
		...
		GoogleAccountCredential credential = GoogleAccountCredential
			.usingOAuth2(context, Arrays.asList(new String[] { scope }))
			.setSelectedAccountName(accountName);
		
		GoogleAuthUtil.getTokenWithNotification(context, accountName, "oauth2:" + scope, null);
