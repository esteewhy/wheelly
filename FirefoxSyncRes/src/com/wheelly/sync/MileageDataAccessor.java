...
public class MileageDataAccessor extends
    AndroidBrowserRepositoryDataAccessor {

  private MileageDataExtender dataExtender;

  public MileageDataAccessor(Context context) {
    super(context);
    dataExtender = new MileageDataExtender(context);
  }

  public MileageDataExtender getHistoryDataExtender() {
    return dataExtender;
  }
