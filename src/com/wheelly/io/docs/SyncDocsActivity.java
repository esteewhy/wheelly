 ...
 * @author Jimmy Shih
 */
public class SyncDocsActivity extends AbstractSendActivity {

  @Override
  protected AbstractSendAsyncTask createAsyncTask() {
    return new SyncDocsAsyncTask(this, sendRequest.getTrackId(), sendRequest.getAccount());
  }

  @Override
  protected String getServiceName() {
    return "GDocs";// getString(R.string.send_google_docs);
  }
